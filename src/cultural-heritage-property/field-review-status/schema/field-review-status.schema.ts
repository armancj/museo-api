...
export type FieldReviewStatusDocument =
  HydratedDocument<FieldReviewStatusInterface>;
...
export const FieldReviewStatusSchema =
  SchemaFactory.createForClass(FieldReviewStatus);

FieldReviewStatusSchema.add(BaseSchemaFactory);

export const FieldReviewStatusEntity = 'FieldReviewStatus';
export type FieldReviewStatusModel = Model<FieldReviewStatusDocument>;
